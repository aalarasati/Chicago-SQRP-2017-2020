...
can only explain a small variation of the school's NWEA growth. Specifically, attendance can only explain the variation in NWEA growth percentile in math and reading by eight and nine percent, respectively. Such evidence suggests there are other factors that influence students' test scores.
```{r}
